...
if case == 1:
    url = 'SMAI\daily_dataset\\Nifty Historical Daily.csv'
elif case == 2:
    url = 'SMAI\daily_dataset\\TCS Historical Daily.csv'
elif case == 3:
    url = 'SMAI\daily_dataset\\HCL Historical Daily.csv'
elif case == 4:
    url = 'SMAI\daily_dataset\\Infy Historical Daily.csv'
elif case == 5:
    url = 'SMAI\daily_dataset\\ONGC Historical Daily.csv'
elif case == 6:
    url = 'SMAI\daily_dataset\\Reliance Historical Daily.csv'
...
plt.plot(step, test_labels, drawstyle = 'steps')
plt.subplot(212)
plt.xlim(-1, len(test_labels) + 1)
plt.ylim(-1, 2)
plt.xlabel('Days')
plt.ylabel('Predicted Values')
plt.plot(step, predicted, drawstyle = 'steps')
plt.show()
